...
from third_party.Grad_TTS.model.utils import sequence_mask, convert_pad_shape
...
class TextEncoder(BaseModule):
    def __init__(self, n_vocab, n_feats, n_channels, filter_channels, 
        ...
        self.encoder = Encoder(n_channels + spk_emb_dim, filter_channels, n_heads, n_layers,
                               kernel_size, p_dropout, window_size=window_size)

        self.proj_m = torch.nn.Conv1d(n_channels + spk_emb_dim, n_feats, 1)
        self.proj_w = DurationPredictor(n_channels + spk_emb_dim, filter_channels_dp,
